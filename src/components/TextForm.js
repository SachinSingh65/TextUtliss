...
export default function TextForm(props) {
    ...
    return (
        <>
            <div className=" mx-5" style={{ color: props.mode === 'dark' ? 'white' : '#042743' }}>
                ...
                <div className="mb-3">
                    <div className="container my-3" style={{ color: props.mode === 'dark' ? 'white' : '#042743' }}>
                        ...
                        <button disabled={text.length === 0} className="btn btn-primary mx-1 my-1" onClick={handleUpClick} >Convert in Uppercase</button>
                        <button disabled={text.length === 0} className="btn btn-primary mx-1 my-1" onClick={handleLoClick} >Convert in Lowercase</button>
